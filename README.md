...
Repository per i progetti di CiceriLab fatti con Claude Code nel cloud.

- `CLAUDE.md` — istruzioni e contesto per Claude (leggilo per primo)
- `docs/concept-lab.md` — il lavoro in corso: rifare i concept 10–20 di cicerilab.com
