...
const CARTE_COLORI = {
  ...
  cotone: {
    ...
    srgb: {
      ...
      luce: [1, 1, 1],
      ombra: [0.63529, 0.63922, 0.60784],
      inchiostro: [0.0902, 0.13725, 0.11373],
      seccoFondo: [0.89412, 0.89804, 0.88235],
      costa: [0.77647, 0.77647, 0.75294],
      taglio: [0.89412, 0.81176, 0.24706],
    },
    lin: {
      fondo: [0.87962, 0.87962, 0.85499],
      luce: [1, 1, 1],
      ombra: [0.36131, 0.36625, 0.32778],
      inchiostro: [0.00857, 0.01681, 0.01229],
      seccoFondo: [0.77582, 0.78354, 0.75294],
      costa: [0.56471, 0.56471, 0.52712],
