 ...
 * - "apri_concept"       apertura del prototipo (params liberi, es. { concept: 15 })
 * - "demo_prenotazione"  prototipo esplorato fino in fondo (prenotazione della settimana a ruota)
 */
